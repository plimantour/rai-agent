...
# Variables
subscription_id="PS France - PlayGround"
resource_group_name="PSFrance_KeyVault"
keyvault_name="AutogenKeyVault"
location="EastUS"
config_file="./OAI_CONFIG_LIST" # Create one from the OAI_CONFIG_LIST_template file
